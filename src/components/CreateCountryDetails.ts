...
export const CreateCountyDetails = (countryDetails: CountryDetails): HTMLDivElement => {
  ...
  const borderLists = <HTMLUListElement>mainContent.querySelector('.country-border-lists');
